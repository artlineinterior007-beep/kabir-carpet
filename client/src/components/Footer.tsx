...
export default function Footer() {
  ...
  return (
    <footer className="bg-neutral-900 text-white py-12" data-testid="footer">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            >
              ...
              <p className="text-white/80 leading-relaxed mb-4 max-w-md">
                Three generations of master craftsmen dedicated to preserving
                the ancient art of carpet weaving, combining traditional
